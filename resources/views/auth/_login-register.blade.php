<div class="modal fade" id="modalLoginRegister" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <form id="formLogin" method="post">
                        <div class="modal-body">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3 px-0">
                                ...
                                <input type="email" class="form-control" id="inputEmail" name="email" placeholder="Email..." tabindex="1"
                                    autofocus />
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3 px-0">
                                <label for="inputPassword">Password</label>
                                <button id="toggle-password" type="button" class="float-right border-0 bg-transparent pt-1 pb-0"
                        ...
                        <div class="modal-footer d-flex justify-content-between">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal" tabindex="4">Tutup</button>
                            <button type="submit" class="btn btn-info" tabindex="3">Masuk</button>
                        </div>
                    </form>
                </div>
                    ...
                    <form id="formRegister" method="post">
                        <div class="modal-body">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3 px-0">
                                ...
                                <input type="text" class="form-control" id="inputName" name="name" placeholder="Name..." tabindex="1"
                                    autofocus />
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3 px-0">
                                <label for="inputEmail">Email</label>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3 px-0">
                                ...
                                <button id="toggle-password-register" type="button" class="float-right border-0 bg-transparent pt-1 pb-0"
                                    aria-label="Show password as plain text. Warning: this will display your password on the screen."
                                    tabindex="7">
                                    Show password
                                </button>
                                <input type="password" class="form-control" id="passwordRegister" name="password"
                                    autocomplete="current-password" placeholder="Password..." tabindex="3" />
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3 px-0">
                                ...
                                <input type="password" id="password-confirmation" name="password_confirmation"
                                    class="form-control @error('password_confirmation') is-invalid @enderror" autocomplete="current-password"
                                    placeholder="Ulangi password..." tabindex="4" />
                            </div>
                        </div>

                        <div class="modal-footer d-flex justify-content-between">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal" tabindex="6">Tutup</button>
                            <button type="submit" class="btn btn-info" tabindex="5">Daftar</button>
                        </div>
                    </form>
                </div>
            </div>
