                    ...
                    <div class="col-md-10">
                        <form action="{{ url('posts') }}" method="GET">
                            ...
                            <div class="input-group input-group-lg">
                                <input class="form-control form-control-lg" type="text" name="search" placeholder="Cari..."
                        ...
                        <div class="post">
                            <div class="post-media post-thumb">
                                <a href="{{ url('posts/' . $posts[0]->slug) }}">
                                    ...
                                    @else
                                        <img class="img-fluid" src="https://dummyimage.com/1098x500/dee2e6/6c757d.jpg" alt="" />
                                    @endif
                                </a>
                            </div>
                            <h3 class="post-title">
                            ...
                            <div class="post">
                                <div class="post-thumb">
                                    <a href="{{ url('posts/' . $post->slug) }}">
                                        @if ($post->img_cover)
                                            <img class="img-fluid" src="{{ asset('storage/image-cover/' . $post->img_cover) }}" alt="">
                                        @else
                                            <img class="img-fluid" src="https://dummyimage.com/1098x500/dee2e6/6c757d.jpg" alt="" />
                                        @endif
                                    </a>
